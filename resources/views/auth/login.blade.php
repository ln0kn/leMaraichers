...
<head>
  ...
  <title>Fruiticapp &amp; Connexion</title>
          ...
          <div class="content content-full">
            ...
            <div class="px-30 py-10">
              <a class="link-effect font-w700">
                ...
                <span class="font-size-xl text-primary-dark">fruit</span><span class="font-size-xl">icapp</span>
              </a>
              <h1 class="h3 font-w700 mt-30 mb-10">Connexion</h1>
              <h2 class="h5 font-w400 text-muted mb-0">Veuillez reseigner le formulaire</h2>
            </div>
            <!-- END Header -->
